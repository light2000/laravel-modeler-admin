...
Route::middleware(['auth:administrator'])->prefix('administrator/user')->group(function () {
    ...
    Route::delete('users/{user}', [UserController::class, 'destroy'])->name('user.user.destroy');
    ...
    Route::delete('administrators/{administrator}', [AdministratorController::class, 'destroy'])->name('user.administrator.destroy');
    ...
    Route::delete('roles/{role}', [RoleController::class, 'destroy'])->name('user.role.destroy');
